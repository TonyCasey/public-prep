        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="space-y-6">
            ...
            <div className="border border-gray-200 rounded-lg overflow-hidden max-w-lg mx-auto">
              <div className="w-full h-48 bg-gradient-to-br from-blue-600 to-blue-800 flex items-center justify-center text-white text-lg font-semibold">
            ...
            <div className="text-center">
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden inline-block">
                <div className="w-full h-64 bg-gradient-to-br from-blue-600 to-blue-800 flex items-center justify-center text-white text-xl font-semibold" style={{ maxWidth: '600px' }}>
                  Full Size Social Preview Image
                </div>
              </div>
            </div>
          </div>
