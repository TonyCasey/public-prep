...
const SampleQuestionCard = memo(({ 
  ...
  const arrowImage = "/attached_assets/image_1752603172600.png";
            ...
            <div className="aspect-[9/16] rounded-lg overflow-hidden shadow-md bg-gray-100 w-full max-w-xs">
              {useExternalVideo ? (
                ...
                <video
                  ...
                  controls
                  preload="none"
                  poster="/attached_assets/video_1752763665067.png"
                  playsInline
                  muted
                  onError={(e) => {
                ...
                >
                  <source src="/attached_assets/Home Page Portrait_1752753602292.mp4" type="video/mp4" />
                  <source src="/attached_assets/Home%20Page%20Portrait_1752753602292.mp4" type="video/mp4" />
                  <source src="/attached_assets/Home_Page_Portrait_1752753602292.mp4" type="video/mp4" />
                ...
                {!sampleAnswer && (
                  <div className="hidden sm:block absolute left-[40px] -top-[40px] pointer-events-none z-10 transition-opacity duration-300">
                    <img
                      ...
                      className="w-[8vw] h-[8vw] min-w-[80px] min-h-[80px] max-w-[120px] max-h-[120px] transform -rotate-12 opacity-80"
                      loading="lazy"
                      decoding="async"
                    />
                  </div>
